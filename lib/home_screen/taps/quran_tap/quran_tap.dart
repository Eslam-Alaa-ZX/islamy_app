    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text("Suras List",style: Theme.of(context).textTheme.titleMedium!.copyWith(color: Color(0xffFEFFE8)),),
        ),
        Expanded(
          child: ListView.separated(
            ...
            itemBuilder: (context,index){
              ...
              return Divider(color: AppTheam.white,thickness: 1,indent: 50,endIndent: 40,);
                }),
        )
      ],
    );
